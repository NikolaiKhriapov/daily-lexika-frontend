...
import { ReviewStatisticsDTO, WordPackDTO } from '../../src/utils/types';
...
import { Breakpoint, FontWeight, Size } from '../../src/utils/constants';
import { getWordPack } from '../../src/services/word-packs';
