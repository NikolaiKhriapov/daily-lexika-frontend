...
import ProfileComponent from '@admin/components/navbar/profile/ProfileComponent';
...
export default function AppNavbar() {
  ...
  return (
    <Container $colorMode={colorMode}>
      <SectionsContainer>
        <Section>
          {!isStandalone && <ContainerMobileAndTablet><AppInstallComponent withPwa /></ContainerMobileAndTablet>}
        </Section>
        <Section>
          <ProfileComponent />
        </Section>
