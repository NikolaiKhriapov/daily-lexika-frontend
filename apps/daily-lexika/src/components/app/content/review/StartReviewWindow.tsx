...
import ReviewWordCard from '@daily-lexika/components/app/content/review/ReviewWordCard';
import WordDataHelper from '@daily-lexika/helpers/WordDataHelper';
import { useProcessReviewActionMutation } from '@daily-lexika/store/api/reviewsAPI';
import { useGetUserQuery } from '@daily-lexika/store/api/userAPI';
import { ReviewDto, Status, WordDto } from '@library/daily-lexika';
import { successNotification } from '@library/shared/services';
import { Button, ButtonsContainer, ButtonType, Modal,ProgressBar } from '@library/shared/ui';
