...
import WordStreakStats from '@daily-lexika/components/app/content/statistics/WordStreakStats';
import WordDataHelper from '@daily-lexika/helpers/WordDataHelper';
import { useGetUserQuery } from '@daily-lexika/store/api/userAPI';
import { useGetWordByWordDataIdQuery } from '@daily-lexika/store/api/wordsAPI';
import { Language, RoleName, WordDataDto, WordDto } from '@library/daily-lexika';
import { ComingSoon, ComingSoonType, Drawer, Spinner, Text } from '@library/shared/ui';
import { Breakpoint, hiddenScrollbar, mediaBreakpointUp, Size  } from '@library/shared/utils';
