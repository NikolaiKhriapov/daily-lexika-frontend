...
import { AuthContext } from '@daily-lexika/context/AuthContext';
import ValidationHelper from '@daily-lexika/helpers/ValidationHelper';
import { useLoginMutation, useRegisterMutation } from '@daily-lexika/store/api/authAPI';
import { useAppDispatch, useAppSelector } from '@daily-lexika/store/hooks/hooks';
import { toggleAuthFormType } from '@daily-lexika/store/reducers/authPageSlice';
import { EmailLinks } from '@daily-lexika/utils/constants';
import { AuthFormType } from '@daily-lexika/utils/types/AuthFormType';
import { AuthenticationRequest, Platform,RegistrationRequest } from '@library/daily-lexika';
