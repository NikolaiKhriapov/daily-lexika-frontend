...
import AppContent from '@daily-budget/components/app/content/AppContent';
import InterfaceLanguageSelectionWindow from '@daily-budget/components/app/content/InterfaceLanguageSelectionWindow';
import AppFooter from '@daily-budget/components/app/footer/AppFooter';
import AppNavbar from '@daily-budget/components/app/navbar/AppNavbar';
import AppSidebar from '@daily-budget/components/app/sidebar/AppSidebar';
      ...
      <Container $colorMode={colorMode}>
        ...
        <SidebarAndContentContainer $colorMode={colorMode}>
          ...
          <AppContent>
            ...
            {user && user.interfaceLanguage && children}
          </AppContent>
