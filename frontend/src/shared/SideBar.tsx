...
import UserAccountWindow from '../components/user/UserAccountWindow';
...
function NavItem({ icon, route, children }: {
  icon: any,
  route: any,
  children: any
}) {
  ...
  return (
    <Link href={route} style={linkStyle} _focus={{ boxShadow: 'none' }}>
      <Flex
        align='center'
        p='4'
        mx='4'
...
function MobileNav({ onOpen }: { onOpen: any }) {
...
function SidebarWithHeader({ children }: { children: any }) {
